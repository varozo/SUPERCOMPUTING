...
- Looked at class notes for lesson 5 to guide me -> i was running into an issue where i was getting an error message that —out1 and —out 2 wher : ERROR: read1 output (--out1) and read2 output (--out2) should be different
- so in my forloop i just made sure to only do the R1 files.
